    ...
    var Navigation = (function () {
      ...
      Navigation.prototype.getServerEndpoint = function (_token, _appId, _onsuccess, _onerror, unignore) {
        ...
        var requestNaviCallback = function (x) {
          ...
          // 默认域名 ws.cn.ronghub.com;
          // 默认端口 81**
          var port = '81'
          var sector = 'ws';
          var server = x["server"];
          server = server.replace(/ws\d+/g, function (val) {
            port = port + val.substr(2);
            return sector;
          }).replace(/\d+/, function (val) {
            return port;
          });
          RongIMLib.RongIMClient._storageProvider._host = Navigation.Endpoint.host = server;
          ...
          RongIMLib.RongIMClient._storageProvider.setItem("navi" + md5Token, server + "," + (x.userId || ""));
  ...
  (function (RongIMLib) {
    ...
    var MessageInputStream = (function () {
      ...
      MessageInputStream.prototype.readMessage = function () {
        // console.log(5181);
        // console.log(this.header.getType());
  ...
  (function (RongIMLib) {
    var SocketTransportation = (function () {
      ...
      SocketTransportation.prototype.onData = function (data) {
        ...
        //   console.log(5580);
        //   console.log(new RongIMLib.MessageInputStream(data));
          this._socket.onMessage(new RongIMLib.MessageInputStream(data).readMessage());
        }
        else {
        //   console.log(5586);
        //   console.log(new RongIMLib.MessageInputStream(RongIMLib.MessageUtil.ArrayFormInput(data)));
